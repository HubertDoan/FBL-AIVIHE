...
export const demoAnnouncementsStore: DemoAnnouncement[] = [
  ...
  {
    id: 'ann-2b',
    title: 'Cập nhật phiên bản mới — vui lòng đăng xuất và đăng nhập lại',
    content: 'Hệ thống vừa cập nhật phiên bản mới với nhiều cải tiến hiệu năng. Vui lòng đăng xuất và đăng nhập lại để nhận đầy đủ tính năng mới.',
    category: 'maintenance',
    target_type: 'all',
    target_groups: [],
    target_citizen_id: null,
